      ...
      <div class="row">
        <div class="col-lg-7">
          ...
          <ul>
            ...
            <li> <a href="product-details.php">Pepper</a> </li>
            <li> <a href="product-details.php">Masalas Garam</a> </li>
          </ul>
        </div>
        <div class="col-md-4 col-sm-6 footer-widget">
        ...
        <div class="col-md-4 col-sm-6 footer-widget">
          <h5 class="widget-title">Payment & Shipping</h5>
          <ul>
        ...
        <div class="col-lg-5 footer-widget contact-widget">
          ...
          <form action="#" method="post">
            ...
            <button type="submit" class="btn-custom primary shadow-none" name="button">Send</button>
            </div>
          </form>
        <ul>
          <li>
          ...
          <li>
            <a href="">
              ...
              Shop No.4, Yashwant CHS., Sector 1, Plot 1, Palm Beach, Sanpada, Navi Mumbai-400 705.</a>
              </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 text-center text-lg-left mb-3 mb-lg-0">
            <p class="m-0">&copy; 2022 <a href="#">Shree Aai Foods </a> | All Rights Reserved.</p>
          </div>
