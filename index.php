...
<!-- Mirrored from metropolitanhost.com/themes/templatemoster/html/masala/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Aug 2022 05:52:12 GMT -->
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Shree Aai Foods - Index</title>
    ...
    <section class="section why-us-2 dark-overlay dark-overlay-2">
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            <div class="section-title-wrap">
              <h2 class="title text-white mb-0">Contact Us </h2>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <h3>Getting Started With <span class="custom-primary"> Masala </span></h3>
            <p></p>
          </div>
        </div>
      </div>
