...
<!-- Mirrored from metropolitanhost.com/themes/templatemoster/html/masala/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Aug 2022 05:59:08 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Shree Aai Foods - Contact</title>
    <!-- Vendor Stylesheets -->
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="ct-info-box">
                        <div class="ct-info-box-icon">
                            ...
                            <span>shreeaaipratishthan@gmail.com</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="ct-info-box">
                        <div class="ct-info-box-icon">
                            ...
                            <h5>Location</h5>
                            <a href="https://goo.gl/maps/LoTEJwo1h8tv7Pri6" target="_blank">
                                <span>Plot no. 19, 3, Sector 6, Sanpada, Navi Mumbai, Maharashtra 400705</span><br>
                            <span>Yashwant CHS, Shop-4, Plot-1, Sector-1, Palm Beach, Sanpada, Navi Mumbai, 400 705</span> 
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="form-group col-lg-12">
                        <textarea name="message" class="form-control" placeholder="Type your message" rows="8" required></textarea>
                    </div>
                </div>
                <button type="submit" class="btn-custom primary" name="submit">Submit</button>
